...
const DoctorDashboard = () => {
  ...
  const pieData = [
    ...
    { label: "Rescheduled", count: statusCounts.Rescheduled || 0, color: "#faad14" },
    { label: "Cancelled", count: statusCounts.Cancelled || 0, color: "#ff4d4f" },
  ];
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <Title level={4} style={{ margin: 0, fontWeight: 600, color: '#52c41a', fontSize: 20 }}>
                    Available
                  </Title>
                ...
                <div style={{ marginTop: '4px' }}>
                  ...
                  <br />
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, color: '#8c8c8c', marginTop: 2 }}>
              ...
              <div style={{
                ...
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                  ...
                  <rect x="10" y="3" width="4" height="14" rx="1.5" fill="#52c41a" fillOpacity="0.6"/>
                  <rect x="16" y="10" width="5" height="7" rx="1.5" fill="#52c41a" fillOpacity="0.3"/>
                </svg>
              </div>
            </div>
          </Card>
