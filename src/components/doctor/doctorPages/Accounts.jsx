...
const AccountsPage = () => {
  ...
  const filteredTransactions = transactions.filter(transaction => {
    ...
    if (searchText && !transaction.patient.toLowerCase().includes(searchText.toLowerCase())) {
      return false;
    }
    ...
    <div style={{ padding: '24px' }}>
      <Row gutter={[16, 16]}>
        <Col span={24}>
          ...
          <Text type="secondary">Manage your financial transactions and earnings</Text>
        </Col>
      </Row>
      ...
      <Card style={{ marginBottom: '24px' }}>
        <Row gutter={16} align="middle">
          ...
          <Col xs={24} sm={12} md={6}>
            <Text strong style={{ display: 'block', marginBottom: '8px' }}>Search Patient</Text>
            <Input
        ...
        <div style={{ padding: '16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
            <div>
              ...
              <Text type="secondary" style={{ display: 'block' }}>From John Smith - Consultation</Text>
              <Text type="secondary">June 15, 2023</Text>
            </div>
            <div style={{ textAlign: 'right' }}>
              <Text strong style={{ color: '#3f8600' }}>+$120.00</Text>
              <Text type="secondary" style={{ display: 'block' }}>Credit Card</Text>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
            <div>
              ...
              <Text type="secondary" style={{ display: 'block' }}>From Michael Brown - Procedure</Text>
              <Text type="secondary">June 12, 2023</Text>
            </div>
            <div style={{ textAlign: 'right' }}>
              <Text strong style={{ color: '#faad14' }}>+$350.00</Text>
              <Text type="secondary" style={{ display: 'block' }}>Bank Transfer</Text>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div>
              ...
              <Text type="secondary" style={{ display: 'block' }}>To Robert Wilson - Vaccination</Text>
              <Text type="secondary">June 8, 2023</Text>
            </div>
            <div style={{ textAlign: 'right' }}>
              <Text strong style={{ color: '#ff4d4f' }}>-$65.00</Text>
              <Text type="secondary" style={{ display: 'block' }}>Credit Card</Text>
            </div>
          </div>
        </div>
