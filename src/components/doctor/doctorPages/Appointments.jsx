...
const Appointment = () => {
  ...
  const handleRescheduleSubmit = async () => {
    ...
    try {
      ...
      const updatedAppointments = storedAppointments.totalAppointments.map((appt) =>
          ...
          <List.Item.Meta
            ...
            title={
              <Space direction="vertical" size={0}>
                ...
                <Text type="secondary">
                  {appointment.appointmentType} - {appointment.appointmentDepartment}
                </Text>
              </Space>
            }
            description={
  ...
  const tabItems = [
    {
      key: '1',
      label: `Scheduled (${appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'scheduled').length})`,
      children: renderAppointmentList(appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'scheduled')),
    },
    {
      key: '2',
      label: `Completed (${appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'completed').length})`,
      children: renderAppointmentList(appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'completed')),
    },
    {
      key: '3',
      label: `Rescheduled (${appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'rescheduled').length})`,
      children: renderAppointmentList(appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'rescheduled')),
    },
    {
      key: '4',
      label: `Canceled (${appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'canceled').length})`,
      children: renderAppointmentList(appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'canceled')),
    },
  ];
            ...
            <Col xs={24} sm={12} lg={6}>
              <Card>
                <Statistic
                  ...
                  value={appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'completed').length}
            ...
            <Col xs={24} sm={12} lg={6}>
              <Card>
                <Statistic
                  ...
                  value={appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'scheduled').length}
            ...
            <Col xs={24} sm={12} lg={6}>
              <Card>
                <Statistic
                  ...
                  value={appointments.totalAppointments.filter((appt) => appt.appointmentStatus === 'rescheduled').length}
            ...
            <Col xs={24} sm={12} lg={6}>
              <Card>
                <Space direction="vertical">
                  ...
                  <Text strong style={{ fontSize: '16px' }}>
                    {appointments.totalAppointments.find((appt) => appt.appointmentStatus === 'canceled')?.patientName ||
                      'No recent cancellations'}
                  </Text>
                  <Text type="secondary" style={{ fontSize: '12px' }}>
                    {appointments.totalAppointments.find((appt) => appt.appointmentStatus === 'canceled')
                      ? new Date(
                          appointments.totalAppointments.find((appt) => appt.appointmentStatus === 'canceled').appointmentDate
                        ).toLocaleDateString() +
                        ' ' +
                        appointments.totalAppointments.find((appt) => appt.appointmentStatus === 'canceled').appointmentTime
                      : 'N/A'}
                  </Text>
                </Space>
              </Card>
