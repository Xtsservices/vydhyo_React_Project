...
export default function ClinicManagement() {
  ...
  const [showPharmacyDetailsModal, setShowPharmacyDetailsModal] =
    useState(false);
  ...
  const [selectedDigitalSignature, setSelectedDigitalSignature] =
    useState(null);
 ...
 const [selectedLabQr, setSelectedLabQr] = useState(null);
  ...
  const [pharmacyQrFile, setPharmacyQrFile] = useState(null);
  const [pharmacyQrPreview, setPharmacyQrPreview] = useState(null);
  const [labHeaderFile, setLabHeaderFile] = useState(null);
  const [labHeaderPreview, setLabHeaderPreview] = useState(null);
  const [labQrFile, setLabQrFile] = useState(null);
  const [labQrPreview, setLabQrPreview] = useState(null);
  ...
  const [selectedClinicForPharmacy, setSelectedClinicForPharmacy] =
    useState(null);
  ...
  const pharmacyQrFileInputRef = useRef(null); 
  const labFileInputRef = useRef(null);
   const labQrFileInputRef = useRef(null);  
  ...
  const handlePlaceChanged = useCallback(() => {
    ...
    if (!place.geometry) {
      ...
      setErrors((prev) => ({
        ...prev,
        address: "Please select a valid address from suggestions",
      }));
      return;
    }
  ...
  const validateClinicForm = () => {
    ...
    if (isEmpty(formData.clinicName))
  ...
  const handleViewPharmacyDetails = async (clinic) => {
    try {
      ...
      if (response?.status === 200) {
        ...
        if (pharmacyDetails) {
        const qrResponse = await apiGet(
          `/users/getClinicsQRCode/${clinic?.addressId}?userId=${doctorId}`
        );

        if (qrResponse.status === 200 && qrResponse?.data?.status === "success") {
          pharmacyDetails = {
            ...pharmacyDetails,
...
setPharmacyQrFile(file);
        setPharmacyQrPreview(reader.result);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     if (labQrFile)          formDataToSend.append("labQR", labQrFile);

     if (pharmacyQrFile)       formDataToSend.append("pharmacyQR", pharmacyQrFile);
      ...
      if (isEditing) {
        ...
        formDataToSend.append(
          ...
          String(Number(formData.longitude))
        );
        formDataToSend.append(
...
if (qrCodeFile)            bypassData.append("clinicQR", qrCodeFile);
         ...
         if (pharmacyQrFile)          bypassData.append("pharmacyQR", pharmacyQrFile);
  ...
  const handleLabSubmit = async (e) => {
    ...
    try {
      ...
      if (
        err.response?.data?.status === "warning" &&
        err.response?.data?.data?.labId
      ) {
  ...
  const handlePharmacySubmit = async (e) => {
    ...
    try {
      ...
      if (pharmacyHeaderFile) {
        formDataToSend.append("pharmacyHeader", pharmacyHeaderFile); // send string
      } if(pharmacyQrFile){
        formDataToSend.append("pharmacyQR", pharmacyQrFile)
      }

      const response = await apiPost(
        "/users/addPharmacyToClinic",
        formDataToSend,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
      ...
      if (
        err.response?.data?.status === "warning" &&
        err.response?.data?.data?.pharmacyId
      ) {
        setWarningMessage(err.response.data.message);
        setWarningEntity("pharmacy");
        const bypassData = new FormData();
  ...
  const handleCloseImagePreview = () => {
    ...
    setSelectedClinicQr(null);
    setSelectedPharmacyQr(null);
    setSelectedLabQr(null);
  };
 ...
 const handleViewClinicQr = async (clinic) => {
   try {
     ...
     if (res.status === 200 && res.data?.status === "success" ) {
      ...
      const url = res?.data?.data?.clinicQrCode || null;
  ...
  return (
            ...
            <table className="clinic-table">
              <thead className="clinic-table-header">
                <tr>
                  ...
                  <th className="clinic-table-th">Clinic QR</th>
            ...
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div>
                ...
                <div className="clinic-form-group">
                  ...
                  />
                  {errors.clinicName && (
                    <div className="clinic-field-error">
                      {errors.clinicName}
                    </div>
                  )}
                </div>
                ...
                <div className="clinic-form-group">
                  ...
                  {errors.address && (
                    <div className="clinic-field-error">{errors.address}</div>
                  )}
                </div>
                ...
                <div className="clinic-form-row">
                  <div className="clinic-form-col">
                    ...
                    />
                    {errors.city && (
                      <div className="clinic-field-error">{errors.city}</div>
                    )}
                  </div>
                  <div className="clinic-form-col">
                    ...
                    />
                    {errors.state && (
                      <div className="clinic-field-error">{errors.state}</div>
                    )}
                  </div>
                </div>
                ...
                <div className="clinic-form-row">
                  <div className="clinic-form-col">
                    ...
                    />
                    {errors.mobile && (
                      <div className="clinic-field-error">{errors.mobile}</div>
                    )}
                  </div>
                  <div className="clinic-form-col">
                ...
                <div className="clinic-form-group">
                  ...
                  <p className="header-upload-note">
                    Note: This signature will be used on prescriptions
                    (optional).
                  </p>
                </div>
   ...
   />
                ...
                <div className="clinic-form-group">
                  ...
                  <p className="header-upload-note">
                    Note: This image will be used as the header for lab-related
                    documents.
                  </p>
                </div>
                  ...
                  <div className="header-upload-container">
                    {labQrPreview ? (
                      <div className="header-preview-container">
                        ...
                        <button
                          className="header-change-button"
                          onClick={() => labQrFileInputRef.current.click()}
                        >
                          Change Image
                        </button>
     </div>
   ...
   />
        ...
        {showHeaderModal && (
          <div className="clinic-modal-overlay" onClick={handleHeaderCancel}>
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              <h2 className="clinic-modal-header">
                Upload Header and Signature for{" "}
                {selectedClinicForHeader?.clinicName}
              </h2>
              ...
              <div className="clinic-form-group">
                ...
                <p className="header-upload-note">
                  Note: This image will be used as the header for prescriptions
                  from this clinic.
                </p>
              </div>
        ...
        {showLabModal && (
          <div className="clinic-modal-overlay" onClick={handleLabCancel}>
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              <h2 className="clinic-modal-header">
                {selectedClinicForLab?.labName
                  ? "Edit Lab Details for"
                  : "Add Lab Details for"}{" "}
                {selectedClinicForLab?.clinicName}
              </h2>
              <div className="clinic-form-group">
                <label className="clinic-form-label">Lab Name</label>
                <input
              ...
              <div className="clinic-form-group">
                ...
                <p className="header-upload-note">
                  Note: This image will be used as the lab payment.
                </p>
              </div>
              <div className="clinic-button-group">
                <button
        ...
        {showPharmacyModal && (
          <div className="clinic-modal-overlay" onClick={handlePharmacyCancel}>
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              <h2 className="clinic-modal-header">
                {selectedClinicForPharmacy?.pharmacyName
                  ? "Edit Pharmacy Details for"
                  : "Add Pharmacy Details for"}{" "}
                {selectedClinicForPharmacy?.clinicName}
              </h2>
              <div className="clinic-form-group">
                <label className="clinic-form-label">Pharmacy Name</label>
                <input
               ...
               <div className="clinic-form-group">
                ...
                <div className="header-upload-container">
                  {pharmacyQrPreview ? (
                    ...
                    <div
                      className="header-upload-placeholder"
                      onClick={() => pharmacyQrFileInputRef.current.click()}
                    >
                      <Upload size={24} />
                      <p>Click to upload pharmacy QR code</p>
                    </div>
                  )}
                  <input
                    type="file"
                ...
                <p className="header-upload-note">
                  Note: This image will be used for pharmacy payment.
                </p>
              </div>
              <div className="clinic-button-group">
                <button
        ...
        {showImagePreviewModal && (
          ...
          >
            <div
              className="clinic-modal image-preview-modal"
              onClick={(e) => e.stopPropagation()}
            >
              <h2 className="clinic-modal-header">
              {selectedClinicQr ? <span>Clinic QR Code</span> : <span> Header and Signature Preview</span>} 
              </h2>
     ...
     <div className="image-preview-section">
       <h3>Clinic QR</h3>
       <img src={selectedClinicQr} alt="Clinic QR" className="image-preview" />
     </div>
   )}
   {selectedPharmacyQr && (
     <div className="image-preview-section">
       <h3>Pharmacy QR</h3>
       <img src={selectedPharmacyQr} alt="Pharmacy QR" className="image-preview" />
     </div>
   )}
   {selectedLabQr && (
     <div className="image-preview-section">
       <h3>Lab QR</h3>
       <img src={selectedLabQr} alt="Lab QR" className="image-preview" />
     </div>
   )}
              </div>
              <div className="clinic-button-group">
          ...
          >
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="pharmacy-details-container">
                ...
                {pharmacyDetails?.pharmacyQrCode && (
          <div className="pharmacy-details-row">
            <span className="pharmacy-details-label">Pharmacy QR Code:</span>
            <div className="pharmacy-header-preview">
              <img
                src={pharmacyDetails.pharmacyQrCode}
              ...
              <div className="pharmacy-details-container">
                ...
                {pharmacyDetails?.pharmacyHeaderImage && ( // ← Change this line
                  <div className="pharmacy-details-row">
                    ...
                    <div className="pharmacy-header-preview">
                      <img
                        src={pharmacyDetails.pharmacyHeaderImage} // ← Change this line
                        alt="Pharmacy Header"
                        className="pharmacy-header-image"
                      />
                    </div>
            ...
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="pharmacy-details-container">
                ...
                {labDetails?.labHeader && (
                 ...
                 {labDetails?.labQrCode && (
          <div className="pharmacy-details-row">
            <span className="pharmacy-details-label">Lab QR Code:</span>
            <div className="pharmacy-header-preview">
              <img
                src={labDetails.labQrCode}
                alt="Lab QR Code"
                className="pharmacy-header-image"
              />
            </div>
        ...
        {showWarningModal && (
          ...
          >
            <div className="clinic-modal" onClick={(e) => e.stopPropagation()}>
              <h2 className="clinic-modal-header">Confirmation</h2>
              <p className="clinic-warning-message">{warningMessage}</p>
              <div className="clinic-button-group">
                <button
                  type="button"
                  className="clinic-cancel-button"
                  onClick={() => {
                    ...
                    toast.info(`Cancelled linking ${warningEntity}`);
                  }}
                >
                  <X size={16} />
                  No
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      if (
                        bypassResponse.status === 200 ||
                        bypassResponse.status === 201
                      ) {
                        toast.success(
